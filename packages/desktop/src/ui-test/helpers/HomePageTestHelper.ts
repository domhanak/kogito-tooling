...
export default class HomePageTestHelper {
    ...
    public openNewBpmn = async (): Promise<void> => {
      await (await this.testedApplication.client.$(this.homePage.openNewBpmnDiagramButtonSelector())).click();
    ...
    public openNewDmn = async (): Promise<void> => {
        await (await this.testedApplication.client.$(this.homePage.openNewDmnDiagramButtonSelector())).click();
    ...
    public openSampleBpmn = async (): Promise<void> => {
        await (await this.testedApplication.client.$(this.homePage.openSampleBpmnDiagramButtonSelector())).click();
    ...
    public openSampleDmn = async (): Promise<void> => {
        await (await this.testedApplication.client.$(this.homePage.openSampleDmnDiagramButtonSelector())).click();
    ...
    private checkDiagramNameHeaderIsPresent = async (name: string): Promise<void> => {
       const diagramNameHeader = await (await this.testedApplication.client.$(this.editorPage.diagramNameHeaderLocator())).getText();
